...
class WC_BPost_Shipping_Meta_Handler {
	...
	public function set_meta( $key, $value ) {
		$this->order->update_meta_data( WC_BPost_Shipping_Meta_Type::BPOST_KEY_PREFIX . $key, $value );
	...
	private function get_value( $key, $type = WC_BPost_Shipping_Meta_Type::VALUE_TYPE_RAW ) {
		...
		$value = $this->order->get_meta( WC_BPost_Shipping_Meta_Type::BPOST_KEY_PREFIX . $key );
